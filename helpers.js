...
exports.menu = [
  { slug: "/preparation", title: "코딩 정보", icon: "tag" },
  { slug: "/javascript", title: "자바스크립트", icon: "post" },
  { slug: "/posts", title: "코딩 생각", icon: "cup" },
  { slug: "/tags", title: "태그", icon: "tag" },
  { slug: "/top", title: "톱 공유", icon: "top" },
  { slug: "/add", title: "정보 추가", icon: "add" },
];
